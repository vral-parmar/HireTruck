...
function deal_final_mail($email,$D_id,$Source,$Destnation,$ord_date){
...
try {
    ...
    $mail->Username = 'enter your maid id';                 // SMTP username
    ...
    $mail->Subject = 'Congrats On your Deal-Here is The Data of the Deal';
    ...
    * {
    ...
    <div style="color:#555555;font-family:`Catamaran`, `Lucida Sans Unicode`, `Lucida Grande`, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 0px;">
        <div style="font-size:12px;line-height:14px;color:#555555;font-family:`Catamaran`, `Lucida Sans Unicode`, `Lucida Grande`, sans-serif;text-align:left;"><ol><li style="font-size: 14px; line-height: 16px; text-align: left;">&#160; Your Deal Id : '.$D_id.'<br><br></li><li style="font-size: 14px; line-height: 16px; text-align: left;"><span style="background-color: rgb(255, 255, 153); font-size: 14px; line-height: 16px;"></span>&#160; Source : '.$Source.'<br><br></li><li style="font-size: 14px; line-height: 16px; text-align: left;">&#160; Destination: '.$Destnation.'<br><br></li><li style="font-size: 14px; line-height: 16px; text-align: left;">&#160; your Carrier Reach You at : '.$ord_date.'</li></ol></div>
    </div>
    </div>
                    <div class="">
